    ...
    <section id="about" className="py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="mx-auto max-w-md lg:max-w-none flex flex-col lg:flex-row gap-12 items-center justify-center">
          <AnimateSection variant="fadeLeft" className="w-full lg:w-1/3 relative aspect-[4/5] rounded-2xl overflow-hidden border border-slate-200 shadow-md">
            <Image
              src="/reval.jpg"
          ...
          <AnimateSection variant="fadeRight" className="w-full lg:w-1/2">
            ...
            <div className="mt-6 flex gap-4">
              <a 
                ...
                className="inline-flex h-9 items-center justify-center rounded-lg border border-slate-200 bg-white px-4 text-xs font-semibold text-slate-700 shadow-sm hover:bg-slate-50 transition-colors gap-2"
              >
